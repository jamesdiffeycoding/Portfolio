export default function Links() {
  return (
    <div className="p-2 mb-4 bg-black duration-500 bg-opacity-30 hover:bg-opacity-50 w-full text-center align-center text-white">
      <ul className="links-container items-center">
        <a
          target="_blank"
          href="https://github.com/jamesdiffeycoding"
