...
export default function Links() {
  ...
  return (
    <div className="p-2 mb-4 bg-black bg-opacity-30 w-full text-center align-center text-white">

      <ul className="links-container items-center">
        <h2 className="font-bold">James Diffey</h2>
        <a target="_blank" href="https://github.com/jamesdiffeycoding" className="links-item button-style-and-hover hover:text-black">
          <svg aria-label="GitHub icon" role="img" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" >
        ...
        <a target="_blank" href="https://linkedin.com/in/jamesdiffey" className="links-item button-style-and-hover hover:text-black">
          <svg aria-label="LinkedIn icon" role="img" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" >
        ...
        <a target="_blank" href="#mailto:diffeyj@outlook.com" className="links-item button-style-and-hover hover:text-black ">
          <svg aria-label="Email icon" role="img" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" >
        ...
        {/* <a target="_blank" href="#" className="links-item button-style-and-hover">   
            <svg aria-label="Resume icon" role="img" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" >
